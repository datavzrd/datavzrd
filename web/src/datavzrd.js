...
export function load() {
    $(document).ready(function() {
        ...
        if (config.is_single_page) {
            $('#right-top-nav').append($('<div class="btn-group" style="padding-right: 4px;"><button class="btn btn-hamburger-nav btn-outline-secondary" type="button" id="clear-filter">Clear filters</button></div>'))
