...
export function render_plot_size_controls() {
    let controls = `
        <div class="row">
            <div class="mt-auto mb-auto ml-auto mr-auto" id="plot-size-control">
                <div class="btn-group" role="group">
                    <button type="button" id="zoom" class="btn btn-outline-secondary"onclick="datavzrd.load_plot(specs, data, false, 100)">
                    ...
                    <button type="button" id="unzoom" class="btn btn-outline-secondary"onclick="datavzrd.load_plot(specs, data, false, -100)">
