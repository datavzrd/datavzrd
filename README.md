...
| keyword            | explanation                                                                                                                                                                                                                                                                  | default |
|--------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|
| type               | Corresponds to the [type](https://vega.github.io/vega-lite/docs/type.html) definition of vega-lite. Either `nominal`, `ordinal` or `quantitative`. This overrides any given scale and color-scheme configuration and provides a quick way to setup any heatmap configuration |         |
...
| domain-mid         | Allows defining the mid point of a given numeric domain. If a domain is specified it must be of length 2.                                                                                                                                                                    |         |
