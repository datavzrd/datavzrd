...
An example report can be [viewed online](http://htmlpreview.github.io/?https://github.com/koesterlab/datavzrd/tree/main/.examples/example-report/index.html) with the [corresponding config file](https://github.com/koesterlab/datavzrd/tree/main/.examples/example-config.yaml).
